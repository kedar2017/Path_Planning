...
class AStar:
    ...
    def search(self):
        ...
        self.gMap[self.gStart] = 0
        self.gMap[self.gEnd] = math.inf
        ...
        while len(self.heap) is not 0:
            ...
            for neighbour in self.neighbours[currPos]:
                ...
                if gCost < self.gMap[neighbour]:
                    ...
                    heapq.heappush(self.heap, (self.fFunc(neighbour), neighbour))

        return self.printPath()

    def fFunc(self, currPos):

        return self.gMap[currPos] + ((self.gEnd[0] - currPos[0])^2 + (self.gEnd[1] - currPos[1])^2)
